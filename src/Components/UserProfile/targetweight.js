...
class targetweight extends Component {
  ...
  submit() {
    ...
    _this.props.setTargetWeightAction(data).then((status) => {
     
      this.setState({
      }, () => {
        if (status.status) {
          //  alert(JSON.stringify(this.props.updateTargetWeight))
    ...
    return (
      ...
      <View style={styles.container}>
        <View style={styles.goal5}>
          <Text style={{ color: "#000", fontSize: 25, marginBottom: 35 }}>{localize.t('targetweightWhat')}?</Text>
        </View>
